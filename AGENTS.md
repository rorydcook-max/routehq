...
Every major business table must be scoped by organization\_id.
...
4\. Important actions must create activity\_events.
...
\- source = ai\_generated

\- verification\_status = pending\_review

\- confidence\_score where available

\- raw\_ai\_payload where available
